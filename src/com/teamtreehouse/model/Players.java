...
//  
//  public static void removePlayer(List<Player> allPlayers, int index){
//    allPlayers.remove(index);
//  }

    public static List<String> playersToString(List<Player> allPlayers) {
        Collections.sort(allPlayers);
        List<String> playersToString = new ArrayList<String>();
        for (Player player : allPlayers) {
            playersToString.add(player.toString());
        }
